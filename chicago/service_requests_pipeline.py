...
Main page:
http://dev.cityofchicago.org/docs/api
Contact:
...
API_BASE_URL = 'http://311api.cityofchicago.org/open311/v2/'
WEB_BASE_URL = 'http://servicetracker.cityofchicago.org/requests/'


class Pipeline(sundew_pipeline.Pipeline):
    name = 'chicago.service_requests'
    ...
    def get_item_url_stages(self):
        ...
        URLs like this:
        http://311api.cityofchicago.org/open311/v2/requests/14-00330587.json?extensions=true
        """
        return [
            self.get_list_urls,
