...
#            from django.db import connection
 #           connection._rollback()
	...
	datadict['image'] = datadict.get('image', None)
	datadict['location_name'] = datadict.get('location_name', None)
	datadict['item_datetime'] = str(datadict.get('item_datetime', None))
	datadict['group_name'] = datadict.get('group_name', None)
	datadict['meeting_name'] = datadict.get('meeting_name', None)
	datadict['item_date'] = str(datadict.get('item_date', None))
        # Calculate title.
        TITLE_MAXLENGTH = 255
...
#        self.created_newsitem_ids.append(ni.id)
	...
	ni['image'] = datadict['image']
	ni['item_datetime'] = datadict['item_datetime']
	ni['group_name'] = datadict['group_name']
	ni['meeting_name'] = datadict['meeting_name']
	ni['item_date'] = datadict['item_date']
