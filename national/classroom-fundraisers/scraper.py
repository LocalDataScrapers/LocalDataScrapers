...
#            from django.db import connection
 #           connection._rollback()
	...
	datadict['teacher_name'] = datadict.get('teacher_name', None)
	datadict['amount'] = datadict.get('amount', None)
	datadict['expiration_date'] = str(datadict.get('expiration_date', None))
        # Calculate title.
        TITLE_MAXLENGTH = 255
...
#        self.created_newsitem_ids.append(ni.id)
	...
	ni['teacher_name'] = datadict['teacher_name']
	ni['amount'] = datadict['amount']
	ni['expiration_date'] = datadict['expiration_date']
